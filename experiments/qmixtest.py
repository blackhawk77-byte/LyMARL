...
def main():
    ...
    parser.add_argument("--chunk_len", type=int, default=HeteroQMIXcfg.chunk_len)
    
    # agent
    parser.add_argument("--hidden_dim", type=int, default=HeteroQMIXcfg.hidden_dim)
    parser.add_argument("--lr", type=float, default=HeteroQMIXcfg.lr)
    parser.add_argument("--gamma", type=float, default=HeteroQMIXcfg.gamma)
    parser.add_argument("--tau", type=float, default=HeteroQMIXcfg.tau)
    parser.add_argument("--grad_clip", type=float, default=HeteroQMIXcfg.grad_clip)
    parser.add_argument("--batch_size", type=int, default=HeteroQMIXcfg.batch_size)
    parser.add_argument("--seq_len", type=int, default=HeteroQMIXcfg.seq_len)
    parser.add_argument("--capacity_episodes", type=int, default=HeteroQMIXcfg.capacity_episodes)
    parser.add_argument("--update_interval_steps", type=int, default=HeteroQMIXcfg.update_interval_steps)
    parser.add_argument("--eps_start", type=float, default=HeteroQMIXcfg.eps_start)
